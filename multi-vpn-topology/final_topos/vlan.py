...
def customTopology():
    ...
    net.addLink(switch1, switch3, port1=2, port2=1)  # s1 (port 2) <-> s3 (port 1)
    net.addLink(switch3, switch2, port1=2, port2=1)  # s3 (port 2) <-> s2 (port 1)
    net.addLink(switch2, host2, port1=2, port2=1)  # s2 (port 2) <-> h2 (port 1)
    net.addLink(switch1, switch4, port1=3, port2=1)  # s1 (port 3) <-> s4 (port 1)
    net.addLink(switch4, switch2, port1=2, port2=3)  # s4 (port 2) <-> s2 (port 3)
